...
file_path = '/home/ramya/70_50ns.xlsx'
...
# Plot the principal axes (full length 2a, 2b, 2c)
ax.quiver(x0, y0, z0, 2*a, 0, 0, color='red', label='Principal Axis 1')
ax.quiver(x0, y0, z0, 0, 2*b, 0, color='magenta', label='Principal Axis 2')
ax.quiver(x0, y0, z0, 0, 0, 2*c, color='cyan', label='Principal Axis 3')
